...
<form role="form">
	...
	<div class="form-group">
		<div class="col-sm-offset-4 col-sm-8">
			<button type="button" class="btn btn-primary" id="surePur">
...
$("#surePur").click(function(){
	...
	$.ajax({
		type:"post",
		data:{mid:mid,sid:sid,qty:qty,dollars:dollars},
		url:"zadministrator/addPurchase.form",
